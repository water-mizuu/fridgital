  ...
  Widget build(BuildContext context) {
    ...
    useEffect(
      () {
        void listener() {
          ...
          debounced = debounce.value = Future.delayed(200.ms, () async {
    ...
    return KeyboardListener(
      ...
      onKeyEvent: (event) {
        ...
        switch (event) {
          case KeyDownEvent(logicalKey: LogicalKeyboardKey.digit1):
            tabController.animateTo(0);
          case KeyDownEvent(logicalKey: LogicalKeyboardKey.digit2):
            tabController.animateTo(1);
          case KeyDownEvent(logicalKey: LogicalKeyboardKey.digit3):
